...
| **FAQ schema** | **oui** — `FAQPage`, ajouté le 24/09/2026 sur les 16 pages du site qui ont une FAQ visible (arbitrage de Franck) ; questions et réponses identiques à celles affichées |
...
|---|---|---|---|---|
| Titre de la section du tableau | §13 donne le tableau sans titre de section | « Comparer les deux approches, critère par critère » | Titre écrit par Claude, **validé par Franck le 24/09/2026** | Le gabarit du site exige un H2 par section ; le titre est descriptif et neutre. Une ligne à changer si tu préfères un autre libellé. |
| Titre de la section de la matrice | §23 donne la matrice sans titre | « S'orienter selon la situation » | Titre écrit par Claude, **validé par Franck le 24/09/2026** | Même raison. |
| Titre du bloc de synthèse du §8 | « Puis faire apparaître clairement : … » | Section « Ce que chacune apporte », en panneau vert sauge | Titre écrit par Claude, **validé par Franck le 24/09/2026** | La phrase ne pouvait pas rester dans le bloc « En bref » : elle se serait collée sous la seule carte « Facette en céramique ». Isolée en panneau, elle se lit comme une synthèse, pas comme un classement. |
...
| §14, §15, §21, §22 | Sections décrites par des listes d'idées à « expliquer » | Rédigées au plus près des mots de la consigne (une à deux phrases de liaison par section, les listes reprises telles quelles) | Rédaction par Claude, **validée par Franck le 24/09/2026** | La consigne ne fournit pas de texte suivi pour ces quatre sections. Tout est relisible et modifiable : `docs/pages-suivantes/v1.5/21_facettes-ou-composite_V1_5.md`. |
| FAQ schema (`FAQPage`) | « uniquement si cela reste cohérent avec l'architecture/schema du site » | **Posé — et étendu à tout le site** | Résolu le 24/09/2026 | Franck a tranché : plutôt qu'une exception sur une page, `FAQPage` est désormais posé sur les **16 pages qui ont une FAQ visible** (84 questions). Les questions et les réponses balisées sont exactement celles qui s'affichent, typographie comprise, et un contrôle automatique le vérifie à chaque fabrication. |
