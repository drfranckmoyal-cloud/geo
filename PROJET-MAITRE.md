...
| **Prochaine action** | Brancher le domaine : chez OVH, faire pointer `drfranckmoyal.fr` et `www` vers le serveur Hostinger, avec l'accord de Franck ; activer le certificat https ; déclarer le site à Google et Bing. En parallèle : ChatGPT répartit et légende les photos (rapport V1.3, §4). |
