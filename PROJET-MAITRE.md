...
| **En attente de Franck** | Le renouvellement de l'offre Hostinger Premium avant le 22/10/2026 ; pour chaque photo retenue, trois confirmations (rapport V1.3, §4) : consentement couvrant la publication web, cas TCA (information de santé sensible), âge du patient MIH lors de l'éclaircissement ; le nom de sa fiche Google et son adresse publique (point 41) ; son accord pour déclarer le site à Google et Bing avec son compte. |
...
| **5** | Mise en ligne : domaine, hébergement, mentions légales, déclaration du site à Google (Search Console)… | **en cours** — site chez Hostinger (D43), domaine branché le 22/09/2026 (D46) ; restent le certificat https (en cours d'installation) et la déclaration à Google et Bing |
...
- **Enregistrements DNS chez OVH** (zone DNS du domaine, dans l'espace OVH de Franck) : depuis le
  ...
  courrier (MX) et SPF d'OVH, inchangés.
