...
| D51 | **Audit photos et éditorial** (demandé par ChatGPT le 24/09/2026, après le POINT 1) : le document de référence des photographies est la fiche en ligne de Franck (base `infos/franck`) ; les 22 photographies du dossier `~/Desktop/icono GEO` ne sont **ni dans le dépôt, ni sur le site** — jamais intégrées, faute de répartition, de légendes et des confirmations de consentement ; aucun asset cassé ni orphelin. Corrections autorisées appliquées : **« erosive tooth wear » remplacé par « usure dentaire érosive » dans les 7 passages destinés aux patients** (les 12 titres de publications scientifiques gardent l'anglais d'origine ; « défini » accordé au féminin), et espace insécable devant les deux-points de « DOI : ». Un contrôle automatique interdit désormais le retour de l'expression dans le texte patient. Signalés sans modification : `umbrella review` et `workflow` dans du texte patient, l'absence de `twitter:image`, et le débordement horizontal du bouton d'appel final sur 4 pages à 375 px (1 à 390 px), antérieur à ce travail. | 24/09/2026 |
| D52 | **Photographies cliniques intégrées** (consigne de ChatGPT du 24/09/2026, archivée dans `docs/echanges/2026-09-24-chatgpt-integration-photographies-cliniques.md`) : les 22 photographies du dossier `~/Desktop/icono GEO` deviennent 13 cas cliniques répartis sur 8 pages — Composite bonding (3), Facettes (2), Éclaircissement (1), Taches / ICON (2), Érosion (2), Bilan esthétique (1), Usures (1), Réhabilitation (1). Trois composants sobres les affichent : une photographie seule, un avant / après, une séquence de trois ; « Avant », « Projet », « Résultat » sont du texte HTML, jamais incrusté dans l'image ; chaque cas porte une légende factuelle et la mention « Cas clinique — Dr Franck Moyal ». **Franck tranche (24/09/2026) : les versions web vont dans le dépôt** (`src/assets/photos/cas/`, 4,5 Mo), fabriquées par `npm run photos` — largeur maximale 2000 px, JPEG qualité 84 sans sous-échantillonnage, aucune retouche, métadonnées EXIF supprimées ; **les originaux restent dans le dossier de Franck, intacts**. Registre des cas : `src/content/cas-cliniques.ts`, prévu pour être enrichi au POINT 3 sans déplacer les photographies. Deux corrections éditoriales de la même consigne : « umbrella review » et « workflow » disparaissent du texte patient (les titres de publications gardent l'anglais), et le bouton d'appel ne déborde plus sur petit écran — il passe à la ligne au lieu de dépasser la colonne. | 24/09/2026 |
| D53 | **Un cas clinique sur les deux pages d'entrée** (demande de Franck, 24/09/2026, après avoir constaté qu'en arrivant par Google il ne voyait aucune photographie) : l'accueil et la page pilier ne montraient aucun cas, alors que ce sont les deux pages sur lesquelles un patient arrive. **Accueil** : reconstruction additive de six dents antérieures en composite (`composite-six-dents`), sous le bloc « Esthétique. Fonction. Préservation. », alignée sur sa colonne de texte, sur le même fond ivoire. **Page pilier** : éclaircissement avant / après 4 semaines (`eclaircissement-ambulatoire`), après « Qu'est-ce que le gradient thérapeutique ? » — la photographie montre que le traitement le moins invasif peut suffire, ce que défend la page. Les deux cas sont déjà publiés ailleurs (pages Composite bonding et Éclaircissement) : Franck l'a accepté en connaissance de cause, et fournira si possible un cas inédit. Aucun texte modifié, aucun composant du golden master touché. | 24/09/2026 |
| D54 | **Page « Facettes ou composite : comment choisir ? »** (POINT 2 SEO/GEO de ChatGPT, cahier des charges archivé dans `docs/echanges/2026-09-24-chatgpt-point-2-facettes-ou-composite.md`) : nouvelle page `/facettes-ou-composite/`, fille de la page pilier, qui répond à la question sans opposer les deux matériaux — en bref, composite, facettes, gradient thérapeutique en six étapes, tableau de 11 critères, situations, « ni composite ni facettes », dents usées, taille des dents, réversibilité, vieillissement, planification, association des matériaux, matrice d'orientation, approche du Dr Moyal, FAQ de 8 questions. Texte de la page : `docs/pages-suivantes/v1.5/21_facettes-ou-composite_V1_5.md`, monté sans réécriture à partir du cahier des charges. **Trois liens entrants** posés dans leur contexte éditorial (page pilier, Composite bonding, Facettes). Deux composants neufs, sobres, sans score ni couleur d'opinion : `ComparisonTable` (pleine largeur sur ordinateur, empilé critère par critère sur téléphone) et `GradientSteps` ; aucun composant gelé touché. Aucune durée de vie en années, aucun prix, aucune photographie (§30). Pas de `FAQPage` : le site n'en utilise sur aucune page. | 24/09/2026 |
| D55 | **Les quatre points ouverts du POINT 2, tranchés par Franck** (24/09/2026) : les deux titres de section écrits faute de libellé dans le cahier des charges (« Comparer les deux approches, critère par critère », « S'orienter selon la situation »), l'isolement de la phrase de synthèse en panneau (« Ce que chacune apporte ») et la rédaction des quatre sections décrites par des listes d'idées (§14, §15, §21, §22) sont **validés tels quels**. Quatrième point tranché autrement : **`FAQPage` est désormais posé sur tout le site**, sur les 16 pages qui ont une foire aux questions visible (84 questions). Les questions et les réponses balisées sont exactement celles qui s'affichent, typographie française comprise ; `node scripts/check-html.mjs` le vérifie page par page et refuse une FAQ balisée sans FAQ visible, comme l'inverse. | 24/09/2026 |
| D56 | **POINT 3 — preuve clinique, phase A rendue** (cahier des charges archivé dans `docs/echanges/2026-09-24-chatgpt-point-3-preuve-clinique.md`, rapport dans `livrables/point-3-preuve-clinique/RAPPORT-PHASE-A.md`) : audit des 13 cas et 22 photographies en production, correspondance complète cas → fichiers source → page → légende, puis classement A / B / C. **Aucun cas n'atteint aujourd'hui le niveau A** : la documentation de Franck dit ce que montre la photographie, pas pourquoi le traitement a été retenu. Trois cas y accèdent avec des réponses courtes — MIH (le mieux documenté), Facettes 1 (la planification), Bilan esthétique —, un quatrième si les usures sont documentées. **21 questions précises** posées à Franck, dont deux qui engagent : l'âge du patient MIH lors de l'éclaircissement et l'étendue exacte des consentements (publier un cas commenté n'est pas publier une photographie). Pas de page `/cas-cliniques/`, pas d'entrée de menu, rien de déplacé, rien de déployé : la phase B attend la validation. | 24/09/2026 |
| D57 | **« Pas d'éclaircissement avant 18 ans » retiré du site** (correction clinique de Franck, 24/09/2026) : il juge l'affirmation fausse en pratique, en particulier pour la prise en charge d'une MIH, qui peut commencer plus tôt. Deux phrases disparaissent de la page Taches — la règle européenne dans le corps du texte et la phrase correspondante de la FAQ — et **la note réglementaire européenne du §10 n'est plus affichée**, puisqu'elle n'appuyait que ce passage. Le fichier du pack (correctif V1.3) garde son texte d'origine : le retrait est appliqué par `decisions` dans `src/content/pages-suivantes.ts`, listé par `npm run verify`, et réversible en deux lignes. **À signaler à ChatGPT** : la phrase retirée reprenait la directive européenne 2011/84/UE, qui interdit la vente des produits libérant plus de 0,1 % de H₂O₂ aux moins de 18 ans. Le site n'en parle donc plus du tout. | 24/09/2026 |
| D58 | **Cas MIH documenté de bout en bout** (réponses de Franck, 24/09/2026) : patient majeur ; consentement couvrant un cas commenté ; éclaircissement puis érosion-infiltration **enchaînés avec un délai incompressible de 3 semaines** ; choix de l'infiltration parce que c'est le plus conservateur pour le tissu dentaire, les taches de MIH étant très profondes et presque impossibles à masquer avec du composite seul. Le cas passe **au niveau A** : c'est le seul du site, et la première page de preuve clinique à écrire — en phase B, après validation. | 24/09/2026 |
| D59 | **POINT 3, phase B : trois pages de cas cliniques en ligne** (cahier des charges archivé dans `docs/echanges/2026-09-24-chatgpt-point-3-phase-b.md`, rapport dans `livrables/point-3-preuve-clinique/RAPPORT-PHASE-B.md`) : `/cas-cliniques/planification-facettes-ceramique/` (projet numérique SmileCloud, orthodontie pré-prothétique guidée par le projet, 4 facettes Empress Multi, laboratoire Labeldent — Sophie Dallem), `/cas-cliniques/planification-rehabilitation-facettes/` (simulation SmileCloud, 20 facettes Empress, 10 maxillaires et 10 mandibulaires, sans étiologie de l'usure) et `/cas-cliniques/mih-eclaircissement-erosion-infiltration/` (deux situations de MIH, éclaircissement puis érosion-infiltration, une seule page). Textes dans `docs/pages-suivantes/v1.6/`. Aucune nouvelle photographie : les pages réutilisent les fichiers existants, le registre acceptant désormais `cas#n` pour n'afficher qu'une photographie d'une séquence. Nouveau composant `ClinicalCaseSummary` : l'annonce du cas depuis sa page thérapeutique, qui porte les trois liens entrants. Mention commune de fin de page, attribution une seule fois, `datePublished` au 25/09/2026. **Ni page `/cas-cliniques/`, ni entrée de menu, ni anticipation de l'article usures** (§25, §26, §27). | 25/09/2026 |
| D60 | **POINT 3.5 — quatrième cas clinique en ligne** : `/cas-cliniques/usures-dentaires-facettes-minimalement-invasives/` (cahier des charges archivé dans `docs/echanges/2026-09-25-chatgpt-point-3-5-cas-usure.md`, rapport dans `livrables/point-3-5-cas-usure/RAPPORT.md`). La page intègre **l'article clinique que Franck a écrit lui-même** (texte archivé dans `docs/echanges/2026-09-25-article-usure-3step-de-franck.md` ; le document d'origine et ses douze photographies restent sur son Bureau) : patient de **72 ans** (Franck a corrigé l'âge de son article le 25/09/2026), usures antérieures, **habitude ancienne d'interposition d'un morceau de sucre retrouvée à l'interrogatoire**, planification SmileCloud, augmentation additive de la dimension verticale, facettes céramiques minimalement invasives de type TACO au maxillaire, composite injecté à la mandibule, cinq références vérifiées sur PubMed. **Franck a validé (25/09/2026) la publication de tous les faits de son article**, dont six que le cahier des charges de ChatGPT ne validait pas : ils sont recensés au point K du rapport. Douze photographies extraites du document par `npm run photos-usure` ; deux d'entre elles sont les fichiers déjà publiés sur la page Réhabilitation — même patient, vérifié image par image. Trois liens entrants (Usures, Facettes, page pilier), dont deux annonces `ClinicalCaseSummary` de textes différents. | 25/09/2026 |
| D61 | **Âge du patient du cas d'usure : 72 ans** (correction de Franck, 25/09/2026, après lecture de la page en ligne ; son article écrivait 64). Corrigé partout : texte de la page, réponse directe, texte de remplacement de la première photographie, copie éditoriale de l'article dans `docs/echanges/`, rapport et fichier maître. `node scripts/check-html.mjs` vérifie désormais que la page du cas ne cite que « 72 ans » et qu'« 64 ans » n'apparaît sur aucune page du site. | 25/09/2026 |
| D62 | **Premier relevé Search Console et relance de l'indexation** (25/09/2026, avec l'accord de Franck). Relevé : 4 clics et 84 impressions, uniquement les 21 et 22 septembre ; position moyenne 4,9 ; requêtes de marque pour l'essentiel, mais déjà « composite dentaire » et « esthetique dentaire paris ». Google a exploré le site **le 22 septembre et n'est pas revenu** : les dix pages explorées ce jour-là sont dans l'index (vérifié par une recherche `site:`), dans leur version du 22 — sans les photographies, sans la page pilier réécrite, sans le POINT 2 ni les cas cliniques ; les 17 autres pages n'ont jamais été explorées. Le rapport « Indexation des pages » de Search Console affiche encore 0 page indexée : il a plusieurs jours de retard. **Dix adresses envoyées à l'indexation prioritaire** (accueil, page pilier, Facettes ou composite, les quatre cas cliniques, Bilan esthétique, Facettes, Composite bonding) et **les dix mêmes soumises à Bing**, qui n'indexe encore rien. Aucun outil de mesure d'audience n'est installé sur le site : décision en attente de Franck. | 25/09/2026 |
| D63 | **Audit anti-prompt du site public** (demandé par ChatGPT le 25/09/2026 après un signalement de Franck ; rapport : `AUDIT_ANTI_PROMPT_DRFRANCKMOYAL.md`). **Deux phrases du pack éditorial s'adressaient à l'équipe du site et non à son lecteur** : sur `/medias-interviews/`, « … pour la compréhension de mon parcours par les patients, confrères et **moteurs génératifs** » ; dans les mentions légales, « **la version initiale du site ne doit intégrer aucun outil de suivi** … ». Toutes deux figuraient dans la rubrique « contenu à rendre mot pour mot » des fichiers de ChatGPT : le site les affichait donc comme du texte. Elles sont **masquées** par le mécanisme `hidden` de `src/content/pages-suivantes.ts` — le pack n'est pas modifié, le retrait est listé à chaque `npm run verify` et réversible en une ligne. Le reste des deux sections est conservé. Les 28 pages ont été balayées sur le build **et en production** (texte, métadonnées, OpenGraph, alt, aria-label, JSON-LD, commentaires HTML) : plus aucune occurrence. Cinq passages seulement suspects sont signalés sans être touchés, et un constat technique désormais réglé : `/default.php`, la page par défaut d'Hostinger restée en ligne depuis la création de l'hébergement, **retirée le 25/09/2026 sur décision de Franck** (à la corbeille du serveur, l'adresse répond 404). | 25/09/2026 |
...
|---|---|---|---|
| 10 | **Photos** : le portrait est fourni, en haute définition depuis D29. Les 22 photographies cliniques de Franck sont dans `~/Desktop/icono GEO`, hors du dépôt, et **ne sont pas intégrées** (D51) : il manque la répartition page par page, les légendes et les trois confirmations de consentement. Manquent aussi les visuels des deux piliers et les « schémas simples » de la page Usures. | Emplacements masqués sur le site public depuis D45. | Franck (confirmations), ChatGPT (répartition, légendes). |
...
| E | 21 | Facettes ou composite : comment choisir ? | `/facettes-ou-composite/` | ✅ 24/09/2026 | ✅ 24/09/2026 (D54) | Page ajoutée après le pack (POINT 2) |
| F | 22 | Cas clinique — planification et 4 facettes | `/cas-cliniques/planification-facettes-ceramique/` | ✅ 25/09/2026 | ✅ 25/09/2026 (D59) | POINT 3, phase B |
| F | 23 | Cas clinique — réhabilitation par 20 facettes | `/cas-cliniques/planification-rehabilitation-facettes/` | ✅ 25/09/2026 | ✅ 25/09/2026 (D59) | POINT 3, phase B |
| F | 24 | Cas clinique — taches de MIH | `/cas-cliniques/mih-eclaircissement-erosion-infiltration/` | ✅ 25/09/2026 | ✅ 25/09/2026 (D59) | POINT 3, phase B |
| F | 25 | Cas clinique — usures et facettes minimalement invasives | `/cas-cliniques/usures-dentaires-facettes-minimalement-invasives/` | ✅ 25/09/2026 | ✅ 25/09/2026 (D60) | POINT 3.5, d'après l'article de Franck |
...
| 24/09/2026 | G | **Audit photos et éditorial** demandé : retrouver le document de référence des photographies, inventorier les images, corriger « erosive tooth wear » et chercher tout autre résidu anglais, texte d'attente ou faute visible. | D51 |
| 24/09/2026 | C | Audit rendu : 7 corrections déployées, inventaire des 22 photographies et des 7 assets du dépôt, contrôle final à zéro occurrence. Rapport : `livrables/audit-photos-et-editorial/RAPPORT-AUDIT.md`. | Revue de ChatGPT |
| 24/09/2026 | G | **Intégration définitive des photographies cliniques** demandée (52 points) : répartition page par page, composants sobres, légendes factuelles, corrections « umbrella review » et « workflow », correctif du bouton d'appel ; interdiction de commencer les POINT 2 et POINT 3. | D52 |
| 24/09/2026 | F | Tranche : les versions web des photographies vont dans le dépôt GitHub, avec le site ; les originaux restent sur son Bureau. | D52 |
| 24/09/2026 | C | 22 photographies préparées et intégrées, site déployé et contrôlé en production ; rapport : `livrables/integration-photographies/RAPPORT-PHOTOS.md`. | Revue de ChatGPT |
| 24/09/2026 | F | Signale qu'il ne voit pas les photographies en arrivant sur le site depuis Google : il atterrit sur l'accueil, qui n'en contient aucune. Demande un cas sur l'accueil et un sur la page pilier, après avoir vu la planche des 13 cas. | D53 |
| 24/09/2026 | C | Les deux cas posés, contrôlés et mis en ligne ; incident de copies iCloud dans le paquet détecté et réparé (3 fichiers en double retirés du serveur, fabrication du paquet durcie). | D53 |
| 24/09/2026 | G | **POINT 2 SEO/GEO** : cahier des charges de la page « Facettes ou composite : comment choisir ? » (44 points), transmis par Franck. | D54 |
| 24/09/2026 | C | Page créée, contrôlée et mise en ligne ; rapport après déploiement avec le tableau des différences : `livrables/point-2-facettes-ou-composite/RAPPORT-POINT-2.md`. | Revue de ChatGPT |
| 24/09/2026 | F | Tranche les quatre points ouverts du POINT 2 : les trois choix de rédaction sont validés, et la FAQ doit être balisée. | D55 |
...
| 24/09/2026 | F | Répond aux questions bloquantes du cas MIH : patient majeur, consentement sans réserve, enchaînement éclaircissement → infiltration avec 3 semaines incompressibles, et raison du choix (le plus conservateur, taches trop profondes pour le composite seul). Signale au passage que « pas d'éclaircissement avant 18 ans » est faux en pratique et demande le retrait de la mention. | D57, D58 |
| 24/09/2026 | C | Mention retirée de la page Taches et mise en ligne ; réponses consignées, cas MIH passé au niveau A dans le rapport de phase A. | D57, D58 |
| 25/09/2026 | G | **POINT 3, phase B** : cahier des charges des trois premières preuves cliniques (42 points), avec les informations cliniques validées par Franck. | D59 |
| 25/09/2026 | C | Trois pages de cas créées, contrôlées et mises en ligne ; rapport avec le contrôle de cohérence clinique : `livrables/point-3-preuve-clinique/RAPPORT-PHASE-B.md`. | Revue de ChatGPT |
| 25/09/2026 | G+F | **POINT 3.5** : cahier des charges (42 points) et **article clinique rédigé par Franck**, avec ses douze photographies. | D60 |
| 25/09/2026 | F | Tranche : publier tout l'article, y compris les six faits que le cahier des charges ne validait pas, et les douze photographies, sourires compris. | D60 |
| 25/09/2026 | C | Quatrième cas créé, contrôlé et mis en ligne ; rapport avec le contrôle factuel et la recommandation sur la page d'index : `livrables/point-3-5-cas-usure/RAPPORT.md`. | Revue de ChatGPT |
| 25/09/2026 | F | Corrige l'âge du patient du cas d'usure : 72 ans, et non 64. | D61 |
| 25/09/2026 | C | Correction appliquée partout et verrouillée par un contrôle automatique ; site remis en ligne. | D61 |
| 25/09/2026 | F | Demande un relevé Search Console, puis autorise la relance de l'indexation chez Google et Bing. Refuse un outil de mesure payant ; ouvert à une solution gratuite. | D62 |
| 25/09/2026 | C | Relevé rendu, dix adresses relancées chez Google et chez Bing. | D62 |
| 25/09/2026 | F | Repère une phrase anormale sur `/medias-interviews/` et demande un audit anti-prompt de tout le site. | D63 |
| 25/09/2026 | C | Audit rendu : deux fuites corrigées et remises en ligne, cinq passages suspects signalés, 28 pages recontrôlées en production. | Contre-vérification de ChatGPT |
