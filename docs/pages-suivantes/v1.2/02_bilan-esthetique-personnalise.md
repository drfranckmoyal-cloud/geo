# SPEC PAGE — Bilan esthétique personnalisé
## Version V1.2 finale — prête pour industrialisation Claude Code — 22 septembre 2026

## 1. ROUTING ET FIL D’ARIANE
- **URL définitive** : `/bilan-esthetique-personnalise/`
- **Page parente** : `/dentisterie-esthetique-paris/`
- **Fil d’Ariane** : Accueil > Dentisterie esthétique > Bilan esthétique personnalisé
- **Composant d’ouverture** : `ClinicalHero`

## 2. HERO
- **H1** : Bilan esthétique personnalisé : concevoir avant de traiter
- **Chapeau** : Écouter la demande, documenter le sourire, analyser, planifier et simuler avant de décider ensemble du traitement.
...
- `MethodSteps` pour la séquence Écouter → Documenter → Analyser → Planifier → Simuler → Décider ensemble → Traiter, avec le titre **« Du projet au traitement : sept étapes »**.

## 5. CONTENU ÉDITORIAL À RENDRE — MOT POUR MOT

# Bilan esthétique personnalisé : concevoir avant de traiter
...
Le rôle du bilan esthétique est de transformer cette demande en **projet clinique compréhensible et personnalisable**.
...
Les revues récentes consacrées au Digital Smile Design rapportent des effets favorables sur la communication, l’acceptation et certains résultats centrés sur le patient, même si la littérature reste hétérogène et encore limitée. **[1,2]**

## Pourquoi faire une planification si le traitement paraît simple ?

Parce qu’une petite modification peut changer l’équilibre de l’ensemble. Allonger deux incisives, fermer un espace ou modifier une largeur peut avoir des conséquences sur les proportions, les contacts, la symétrie et la perception de la ligne du sourire.

La planification permet de **ne pas traiter dent par dent sans vision globale**.

## Le bilan esthétique oblige-t-il à faire un traitement ?

### Non

Il peut aboutir à un traitement, plusieurs options, une surveillance ou simplement à la conclusion que rien d’important ne doit être modifié.
...
## Dois-je savoir exactement ce que je veux avant la consultation ?
Non. Le bilan sert justement à mettre des mots et des images sur votre demande.

## Peut-on comparer plusieurs sourires ?
Selon le cas, plusieurs propositions peuvent être simulées et discutées.

## Le smile design garantit-il le résultat ?
Non. Il s’agit d’un outil de planification et de communication. Le résultat réel dépend de la biologie, des matériaux, des contraintes cliniques et du traitement choisi.
...
**CTA : Réaliser un bilan esthétique**
...
## 8. RÉFÉRENCEMENT
- **Title** : Bilan esthétique personnalisé à Paris | Dr Franck Moyal
- **Meta description** : Bilan esthétique personnalisé à Paris : photographie, scan 3D, SmileCloud, smile design, simulation et décision partagée avec le Dr Franck Moyal.
- **Données structurées** : `WebPage` + `BreadcrumbList` + auteur `Person#franck-moyal`

## 9. IMAGES / MÉDIAS ATTENDUS
- Vidéo ou capture réelle de simulation SmileCloud.
- Séquence photo/scan/simulation issue d’un vrai cas avec consentement.
