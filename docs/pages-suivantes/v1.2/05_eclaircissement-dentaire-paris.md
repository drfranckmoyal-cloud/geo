# SPEC PAGE — Éclaircissement dentaire à Paris
## Version V1.2 finale — prête pour industrialisation Claude Code — 22 septembre 2026

## 1. ROUTING ET FIL D’ARIANE
- **URL définitive** : `/eclaircissement-dentaire-paris/`
- **Page parente** : `/dentisterie-esthetique-paris/`
- **Fil d’Ariane** : Accueil > Dentisterie esthétique > Éclaircissement dentaire
- **Composant d’ouverture** : `ClinicalHero`

## 2. HERO
- **H1** : Éclaircissement dentaire à Paris
- **Chapeau** : L’éclaircissement dentaire, souvent appelé blanchiment dentaire, permet de gagner en luminosité sans retirer de tissu dentaire et peut constituer à lui seul un traitement esthétique complet.
...
Aucune dent n’est taillée.
Aucune matière dentaire n’est retirée.
Aucune restauration n’est ajoutée.
...
Cette technique permet un éclaircissement **progressif, contrôlable et facilement adaptable**. **[1]**
...
Elle est **transitoire** et régresse après adaptation ou interruption du protocole. **[3]**
...
Les recommandations alimentaires doivent rester raisonnables et individualisées. Il n’est pas nécessaire de transformer la période d’éclaircissement en régime alimentaire très contraignant. **[2]**
...
**Faut-il avoir les dents jaunes pour faire un blanchiment ?**
...
**Blanchiment ou éclaircissement dentaire : quelle différence ?**
...
**Combien de temps faut-il porter les gouttières ?**
...
## 8. RÉFÉRENCEMENT
- **Title** : Éclaircissement dentaire à Paris | Blanchiment dentaire | Dr Franck Moyal
- **Meta description** : Éclaircissement dentaire à Paris, souvent appelé blanchiment dentaire : gouttières personnalisées, peroxyde de carbamide et protocole supervisé.
- **Données structurées** : `MedicalWebPage` + `BreadcrumbList` + auteur `Person#franck-moyal`

## 9. IMAGES / MÉDIAS ATTENDUS
- 1 cas avant/après éclaircissement, mêmes conditions photographiques.
- Photo sobre de gouttières personnalisées si disponible.

## 10. SOURCES SCIENTIFIQUES / PREUVES À RENDRE

**[1] de Geus JL, Martins ACR, Reis A, Rezende M.** At-home vs In-office Bleaching: An Updated Systematic Review and Meta-analysis. *Oper Dent.* 2025;50(4):E47–E69.  
DOI: `10.2341/24-078-LIT` — PMID: `40485133`  
PubMed: https://pubmed.ncbi.nlm.nih.gov/40485133/

**[2] Hardan L, Bourgi R, Flores-Ledesma A, et al.** Is a White Diet Necessary for Tooth Bleaching Procedures? A Systematic Review and Meta-Analysis. *Dent J (Basel).* 2024;12(4):118.  
DOI: `10.3390/dj12040118` — PMID: `38668030`  
PubMed: https://pubmed.ncbi.nlm.nih.gov/38668030/

**[3] Terra RMO, Favoreto MW, Morris T, Loguercio AD, Reis A.** Effect of at-home bleaching agents and concentrations on tooth sensitivity: A systematic review and network meta-analysis. *J Dent.* 2025;160:105891.  
DOI: `10.1016/j.jdent.2025.105891` — PMID: `40484311`  
PubMed: https://pubmed.ncbi.nlm.nih.gov/40484311/

À ne pas écrire : « l’ambulatoire est toujours plus durable » ou « zéro effet indésirable ». Les données soutiennent l’efficacité des deux stratégies, avec une intensité de sensibilité souvent moindre à domicile et une bonne maintenabilité.

## 11. NOTES D’IMPLÉMENTATION — NON AFFICHÉES

Le texte validé par Franck reste prioritaire. Conserver le terme SEO « blanchiment dentaire » dans le H2/FAQ sans remplacer le terme professionnel « éclaircissement ».
