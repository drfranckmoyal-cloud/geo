# SPEC PAGE — Facettes dentaires à Paris
## Version prête pour industrialisation Claude Code — 21 septembre 2026

## 1. ROUTING ET FIL D’ARIANE
- **URL définitive** : `/facettes-dentaires-paris/`
- **Page parente** : `/dentisterie-esthetique-paris/`
- **Fil d’Ariane** : Accueil > Dentisterie esthétique > Facettes dentaires
- **Composant d’ouverture** : `ClinicalHero`

## 2. HERO
- **H1** : Facettes dentaires à Paris : redessiner et sublimer un sourire
- **Chapeau** : Un projet de facettes permet de redessiner formes, proportions, longueurs, volumes et lumière du sourire à partir d’une planification construite avec le patient.
...
# Facettes dentaires à Paris : redessiner et sublimer un sourire
...
La simulation ne constitue pas une photographie contractuelle du résultat final. Elle permet surtout de rendre le projet visible, de comparer plusieurs directions et d’aligner patient, praticien et laboratoire. Les revues récentes sur le Digital Smile Design suggèrent un intérêt pour la communication et les résultats centrés sur le patient, tout en soulignant encore l’hétérogénéité des études disponibles. **[1,2]**
...
La priorité est donc : **obtenir la forme souhaitée tout en préservant le maximum d’émail compatible avec le projet**. Les données récentes retrouvent de meilleurs résultats lorsque les facettes sont principalement collées à l’émail plutôt qu’à une dentine largement exposée. **[3]**
...
Les facettes céramiques présentent des taux de survie élevés dans les études à long terme. Une méta-analyse récente rapporte, selon les matériaux, des taux de survie groupés autour de 94 à 97 % à environ dix ans pour plusieurs familles de céramiques, tout en rappelant que survie et absence totale de complication ne sont pas synonymes. **[4]**

La qualité du collage, la quantité d’émail disponible, l’occlusion, les habitudes du patient et l’entretien influencent le pronostic. **[3,4]**

## À quoi ressemble réellement le parcours ?

1. Comprendre ce que vous souhaitez changer
2. Photographier et scanner
3. Analyser le visage et le sourire
4. Dessiner plusieurs propositions si nécessaire
5. Choisir ensemble une direction
6. Déterminer la quantité minimale de préparation compatible avec le projet
7. Transmettre le design au céramiste
8. Valider les pièces
9. Coller
10. Contrôler et entretenir
...
## Peut-on faire des facettes sans tailler les dents ?
...
## Peut-on choisir la forme des dents ?
Oui. C’est même une partie essentielle de la planification.

## Peut-on voir le futur sourire avant le traitement ?
...
## Les facettes font-elles forcément artificielles ?
...
**CTA : Planifier une consultation esthétique**
...
## 8. RÉFÉRENCEMENT
- **Title** : Facettes dentaires à Paris | Smile design | Dr Franck Moyal
- **Meta description** : Facettes dentaires à Paris : smile design, simulation, céramique, préparation conservatrice et projet esthétique personnalisé avec le Dr Franck Moyal.
- **Données structurées** : `MedicalWebPage` + `BreadcrumbList` + auteur `Person#franck-moyal`

## 9. IMAGES / MÉDIAS ATTENDUS
- 2 cas facettes complets : état initial → projet → résultat.
- Vidéo / simulation SmileCloud réelle.
- Photo laboratoire/céramique uniquement si réelle et premium.

## 10. SOURCES SCIENTIFIQUES / PREUVES À RENDRE

**[1] Alqutaibi AY, Saker S, Alghauli MA, et al.** Clinical survival and complication rate of ceramic veneers bonded to different substrates: A systematic review and meta-analysis. *J Prosthet Dent.* 2025;134(4):1030–1039.  
DOI: `10.1016/j.prosdent.2024.03.019` — PMID: `38604905`  
PubMed: https://pubmed.ncbi.nlm.nih.gov/38604905/

**[2] Klein P, Spitznagel FA, Zembic A, et al.** Survival and Complication Rates of Feldspathic, Leucite-Reinforced, Lithium Disilicate and Zirconia Ceramic Laminate Veneers: A Systematic Review and Meta-Analysis. *J Esthet Restor Dent.* 2025;37(3):601–619.  
DOI: `10.1111/jerd.13351` — PMID: `39523553`  
PubMed: https://pubmed.ncbi.nlm.nih.gov/39523553/

**[3] Alwabel LK, et al.** Digital Smile Design and Patient-Centered Outcomes in Esthetic Restorative Dentistry: A Systematic Review. *Cureus.* 2025;17(11):e98084.  
