# SPEC PAGE — Composite bonding à Paris
## Version prête pour industrialisation Claude Code — 21 septembre 2026

## 1. ROUTING ET FIL D’ARIANE
- **URL définitive** : `/composite-bonding-paris/`
- **Page parente** : `/dentisterie-esthetique-paris/`
- **Fil d’Ariane** : Accueil > Dentisterie esthétique > Composite bonding
- **Composant d’ouverture** : `ClinicalHero`

## 2. HERO
- **H1** : Composite bonding à Paris : reconstruire une dent avec précision, sans l’uniformiser
- **Chapeau** : Une technique additive et conservatrice dont le résultat esthétique dépend fortement de la planification, de la stratification, de la forme et des finitions.
...
# Composite bonding à Paris : reconstruire une dent avec précision, sans l’uniformiser
...
Mais en esthétique antérieure, tous les résultats ne se ressemblent pas. La qualité finale dépend fortement de la planification, de la maîtrise de la forme, de la stratification, des finitions et du polissage. Les données disponibles montrent d’ailleurs que les facteurs opérateur et technique influencent les performances cliniques des restaurations antérieures. **[1–3]**
...
Dans les cas les plus exigeants, **la finition et le polissage ne sont pas des détails** : ils participent directement à l’intégration optique, à la texture et au comportement de surface du composite. **[4]**

## Quelle est la durée de vie d’un composite bonding ?

### Plusieurs années, avec une logique d’entretien

Les restaurations composites antérieures présentent des performances cliniques satisfaisantes, mais leur longévité varie selon l’indication, la taille de la restauration, l’occlusion, les habitudes du patient, le protocole adhésif et les facteurs opérateur. Les réparations et réinterventions font partie de leur cycle de vie. **[2,3,5]**
...
## 8. RÉFÉRENCEMENT
- **Title** : Composite bonding à Paris | Stratification composite | Dr Franck Moyal
- **Meta description** : Composite bonding à Paris : stratification composite, fermeture de diastème, reconstruction antérieure et approche conservatrice avec le Dr Franck Moyal.
- **Données structurées** : `MedicalWebPage` + `BreadcrumbList` + auteur `Person#franck-moyal`

## 9. IMAGES / MÉDIAS ATTENDUS
- 2 cas de composite antérieur stratifié, cadrage constant.
- 1 cas fermeture de diastème / Front Wing si consentement.
- Macro-photo de texture et stratification si disponible.

## 10. SOURCES SCIENTIFIQUES / PREUVES À RENDRE

**[1] Wolff D, Frese C, Frankenberger R, et al.** Direct Composite Restorations on Permanent Teeth in the Anterior and Posterior Region — An Evidence-Based Clinical Practice Guideline — Part 1: Indications for Composite Restorations. *J Adhes Dent.* 2024;26:185–200.  
DOI: `10.3290/j.jad.b5748881` — PMID: `39286910`  
PubMed: https://pubmed.ncbi.nlm.nih.gov/39286910/

**[2] Burke FJT.** Longevity of Indirect and Direct Restorations in Anterior Teeth. *Prim Dent J.* 2023;12(2):76–84.  
DOI: `10.1177/20501684231175591` — PMID: `37313877`  
PubMed: https://pubmed.ncbi.nlm.nih.gov/37313877/

**[3] Shah YR, Shiraguppi VL, Deosarkar BA, Shelke UR.** Long-term survival and reasons for failure in direct anterior composite restorations: A systematic review. *J Conserv Dent.* 2021;24(5):415–420.  
DOI: `10.4103/jcd.jcd_527_21` — PMID: `35399771`  
PubMed: https://pubmed.ncbi.nlm.nih.gov/35399771/

**[4] Devlukia S, Hammond L, Malik K.** Is surface roughness of direct resin composite restorations material and polisher-dependent? A systematic review. *J Esthet Restor Dent.* 2023;35(6):947–967.  
DOI: `10.1111/jerd.13102` — PMID: `37458370`  
PubMed: https://pubmed.ncbi.nlm.nih.gov/37458370/
